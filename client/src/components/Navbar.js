...
const Navbar = () => {
  ...
  return (
    <div className="flex border-b-2 md:duration-300 border-slate-950 justify-between w-screen py-6 px-24 md:px-2">
      <div>
        <Link to={"/"}>
      ...
      >
        <Link
          className="text-lg md:text-2xl duration-300 font-semibold text-zinc-500 md:text-black hover:text-black"
          to={"/store/all"}
        >
          Store
        </Link>
        <Link
          className="text-lg md:text-2xl font-semibold duration-300 text-zinc-500 md:text-black hover:text-black"
          to={`/cart`}
        >
          Cart
        </Link>
        ...
        {isAuthenticated && (
          <div className="flex gap-4 place-items-center">
            <img
              ...
              alt="user"
            />
            <div className="text-lg md:text-2xl font-semibold duration-300 text-zinc-500 md:text-black hover:text-black">
              {user.name}
            </div>
          </div>
        )}
